...
<?php
	...
	$query = "Select id_inf, titulo, texto_centro, texto_rodape from
		  informacoes where ativo='S' and local_exibicao = '1'
...
<p>&nbsp;</p>
                <hr class="col-md-12">
                <p> <?php echo "{$item['texto_rodape']} "; ?></p>
<hr>
 

<div align="right">
<h5 align="right"><strong>CONFIRA NA ÍNTEGRA:</strong> </h5>
        <ul style="list-style-type:none;">
		  ...
		  order by id_arquivo desc;";
		   ...
		   while($registro_arq = mysqli_fetch_assoc($resultado_arq)){
			 ...
			 echo "<li> <a href='intranet/uploads/$arquivo' target='_blank' download='$desc $arquivo' title='$arquivo'> &gt;&gt; $descricao </a></li> "; 
		}			   
            ?>
        </ul>
    </div>
