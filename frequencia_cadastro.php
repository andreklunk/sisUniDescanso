...
<?php
	...
	if(isset($_GET['id'])!=null){
		...
		$query = "Select id_pessoa, nome, sobrenome, cpf from pessoa where id_pessoa = '$cod_p'";
	} else {
		$cpf = $_GET['valor1'];
		$query = "Select id_pessoa, nome, sobrenome, cpf from pessoa where cpf = '$cpf'";
	}
...
<form action="frequencia_cadastroBD.php" method="post" enctype="multipart/form-data" class="form-horizontal" onSubmit="return validaForm();">
...
<br>Preecha os dados abaixo para concluir a solicitação do auxílio estudante
<br><br>
<!-- Select Basic -->
<div class="form-group">
...
<div class="form-group">
  ...
  <div class="col-md-2">
  <input name="num_dias" type="number" required class="form-control input-md" id="num_dias" placeholder="Nº dias de transporte" max="6" min="1" title="Nº de dias que utiliza transporte" maxlength="1">    
...
<div class="form-group">
  ...
  <div class="col-md-2">
  <input name="num_disciplina" type="number" required class="form-control input-md" id="num_disciplina" placeholder="Nº de Disciplinas no Semestre Atual" min="1" title="Nº de Disciplinas no Semestre Atual" maxlength="1">     
  </div>Frequentadas no Semestre
</div>

<!--teve reprovação?-->
<div class="form-group">
  <label class="col-md-4 control-label" for="banco">Reprovação?</label>
    <div class="col-md-6">
    <input name="reprovacao" type="checkbox" id="reprovacao" onClick="verificaSuperior(this);" value="S"> &nbsp;Selecione em caso de reprovação no semestre anterior?
    </div>
</div> 
  
<div class="cl_superior" id="div_reprovacao"><!-- Div Possuo Conta -->
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="num_dias">Nº Disciplinas Reprovadas</label>  
  <div class="col-md-2">
  <input name="num_reprovacao" type="number" class="form-control input-md" id="num_reprovacao" placeholder="Nº de Disciplinas Reprovadas" min="1" title="Nº de Disciplinas Reprovadas" maxlength="1">    
  </div>
</div>
</div><!--fim se teve reprovacao-->
