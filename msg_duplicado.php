...
<div class="panel panel-default">
  ...
  <div class="panel-heading">
      <h4 style="color:#F00"> Não foi possível finalizar essa solicitação!<br>
      </h4>
  </div>
  <div class="panel-body">
        <p> Somente <strong>01 (uma)</strong> única solicitação é permitida por Semestre!<br>
          Caso já tenha feito o cadastro e tenha errado nas informações, entre em contato com a Prefeitura Municipal para alteração!
        </p>
        <p></p>
   </div>
</div>
