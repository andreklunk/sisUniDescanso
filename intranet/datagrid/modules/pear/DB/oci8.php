...
class DB_oci8 extends DB_common
{
    ...
    function simpleQuery($query)
    {
        ...
        // ApPHP modification - START #001 - (Suggested by deeptibaghel 3.07.2009) 
        // There was a semicolon getting appended to the delete and insert queries,
        // so invalid character was being reported.        
        $query = trim($query,";");
        // ApPHP modification - END #001 - 
    ...
    function numRows($result)
    {
        ...
        //if ($this->options['portability'] & DB_PORTABILITY_NUMROWS && $result === $this->last_stmt)

        // ApPHP modification - START #002 - (10.03.2010) 
        // Gives an error if use a previous condition
        if ($result === $this->last_stmt)
        // ApPHP modification - END #002 - 
        {
