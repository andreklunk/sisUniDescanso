...
$_SESSION['us_nome'];
 ...
 ##  *** put a primary key on the first place 
    $sql=" SELECT 
            ...
            ativo                    
        FROM tipo_doc";
  $default_order = array("tipo_descricao"=>"ASC");
...
//  $export_all = false;
 ...
 /// $fill_from_array = array("0"=>"No", "1"=>"Yes");  /* as "value"=>"option" */
  $filtering_fields = array(
    "Tipo Documento"       =>array("type"=>"textbox",  "table"=>"tipo_doc", "field"=>"tipo_descricao", "show_operator"=>"false", "default_operator"=>"like%", "case_sensitive"=>"false", "comparison_type"=>"string", "width"=>"200px", "on_js_event"=>""),
  );
 ...
 /// $fill_from_array = array("0"=>"No", "1"=>"Yes", "2"=>"Don't know", "3"=>"My be"); /* as "value"=>"option" */
    $em_columns = array(
        "tipo_descricao"        =>array("header"=>"Tipo Documento",       "type"=>"textbox",  "width"=>"340px", "req_type"=>"rt", "title"=>"Razão Social"),
        "ativo"        =>array("header"=>"Ativa",     "type"=>"checkbox", "req_type"=>"st", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", 				"default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "true_value"=>"S", "false_value"=>"N")  
    );
