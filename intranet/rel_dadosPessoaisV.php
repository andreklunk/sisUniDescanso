...
<div id="corpo">
 <h3> Dados Pessoais - Alunos com Solicitações - Situação</h3>  
  <p>
  ...
  <?php
    ...
    <button type="button" class="btn btn-primary" id="button" onclick="envia_rel('pdf_dadosPessoaisV.php')">Imprimir</button> 
    </form>
