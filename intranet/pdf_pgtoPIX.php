...
$query = "Select P.id_parcela, descricao, semestre, ano,id_frequencia, nome, 
         cpf, banco, agencia, conta, tipo_conta, pix, valor
         from pagamento P, parcela PA 
		 where P.id_parcela=PA.id_parcela
		 and PA.ano = '$ano' and PA.semestre='$semestre' ";
if($banco){
	if($banco=='S') { $query .=  "and banco = '' ";}
	else  $query .=  "and banco = '$banco' ";
}
...
$pdf->Cell($l+150, $a, $pix, 0, 0, 'C',true);
