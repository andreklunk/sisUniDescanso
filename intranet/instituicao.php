...
$_SESSION['us_nome'];
 ...
 ##  *** put a primary key on the first place 
    $sql=" SELECT 
            ...
            instituicao, 
            cidade                    
        FROM instituicao where id_instituicao > 1";
  $default_order = array("instituicao"=>"ASC");
 ...
 ##  *** set DataGrid caption
  $dg_caption = "Instituições de Ensino</a>";
...
//  $export_all = false;
 ...
 /// $fill_from_array = array("0"=>"No", "1"=>"Yes");  /* as "value"=>"option" */
  $filtering_fields = array(
    "Instituição"       =>array("type"=>"textbox",  "table"=>"instituicao", "field"=>"instituicao", "show_operator"=>"false", "default_operator"=>"like%", "case_sensitive"=>"false", "comparison_type"=>"string", "width"=>"200px", "on_js_event"=>""),
    "Cidade"       =>array("type"=>"textbox",  "table"=>"instituicao", "field"=>"cidade", "show_operator"=>"false", "default_operator"=>"like%", "case_sensitive"=>"false", "comparison_type"=>"string", "width"=>"100px", "on_js_event"=>"") );
 ...
 ##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
  ...
  $vm_colimns = array(
    "instituicao"       =>array("header"=>"Instituição", "type"=>"label", "align"=>"left", "wrap"=>"wrap",   "text_length"=>"40", "case"=>"normal"),
    "cidade"       =>array("header"=>"Cidade", "type"=>"label", "align"=>"left", "wrap"=>"wrap",   "text_length"=>"20", "case"=>"normal")
  );
 ...
 ##  ***  set settings for add/edit/details modes
    $table_name  = "instituicao";
    $primary_key = "id_instituicao";
    $condition   = "";
    $dgrid->SetTableEdit($table_name, $primary_key, $condition);
 ##  *** set columns in edit mode   
 /// $fill_from_array = array("0"=>"No", "1"=>"Yes", "2"=>"Don't know", "3"=>"My be"); /* as "value"=>"option" */
    $em_columns = array(
        "instituicao"        =>array("header"=>"Instituição",       "type"=>"textbox",  "width"=>"340px", "req_type"=>"rt", "title"=>"Instituição"),
        "cidade"        =>array("header"=>"Cidade",       "type"=>"textbox",  "width"=>"140px", "req_type"=>"st", "title"=>"Cidade")     
    );
