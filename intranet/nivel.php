...
$_SESSION['us_nome'];
 ...
 ##  *** put a primary key on the first place 
    $sql=" SELECT 
            ...
            nivel                    
        FROM nivel";
  $default_order = array("id_nivel"=>"ASC");
 ...
 ##  *** set DataGrid caption
  $dg_caption = "Níveis - Categorias de Ensino</a>";
...
//  $export_all = false;
 ...
 /// $fill_from_array = array("0"=>"No", "1"=>"Yes");  /* as "value"=>"option" */
  $filtering_fields = array(
    "Nível"       =>array("type"=>"textbox",  "table"=>"nivel", "field"=>"nivel", "show_operator"=>"false", "default_operator"=>"like%", "case_sensitive"=>"false", "comparison_type"=>"string", "width"=>"200px", "on_js_event"=>"") );
 ...
 ##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
  ...
  $vm_colimns = array(
    "nivel"       =>array("header"=>"Nível", "type"=>"label", "align"=>"left", "wrap"=>"wrap",   "text_length"=>"40", "case"=>"normal")
  );
 ...
 ##  ***  set settings for add/edit/details modes
    $table_name  = "nivel";
    $primary_key = "id_nivel";
    $condition   = "";
    $dgrid->SetTableEdit($table_name, $primary_key, $condition);
 ##  *** set columns in edit mode   
 /// $fill_from_array = array("0"=>"No", "1"=>"Yes", "2"=>"Don't know", "3"=>"My be"); /* as "value"=>"option" */
    $em_columns = array(
        "nivel"        =>array("header"=>"Nível",       "type"=>"textbox",  "width"=>"340px", "req_type"=>"rt", "title"=>"Nível Educacional")   
    );
