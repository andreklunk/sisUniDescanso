...
$_SESSION['us_nome'];
 ...
 ##  *** put a primary key on the first place 
    $sql=" SELECT 
			...
			texto_centro,
			texto_rodape, 
			case local_exibicao when '1' then 'Início'
            when '2' then 'Informações'
 ...
 ##  *** set DataGrid caption
  $dg_caption = "Informações - Tela Inicial</a>";
...
//  $export_all = false;
 ...
 /// $fill_from_array = array("0"=>"No", "1"=>"Yes");  /* as "value"=>"option" */
  $filtering_fields = array(
    "Título"       =>array("type"=>"textbox",  "table"=>"informacoes", "field"=>"titulo", "show_operator"=>"false", "default_operator"=>"like%", "case_sensitive"=>"false", "comparison_type"=>"string", "width"=>"200px", "on_js_event"=>"") );
 ...
 ##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
  $fill_from_array = array("1"=>"Início", "2"=>"Informações"); /* as "value"=>"option" */
  $vm_colimns = array(
    "titulo"       =>array("header"=>"Título", "type"=>"label", "align"=>"left", "wrap"=>"wrap",   "text_length"=>"40", "case"=>"normal"),
	"local_exibicao"     => array("header"=>"Local Exibição",     "type"=>"label",  "align"=>"left", "width"=>"90px", "wrap"=>"wrap|nowrap", "text_length"=>"-1", "tooltip"=>"false", "tooltip_type"=>"floating|simple", "case"=>"normal", "summarize"=>"false", "sort_type"=>"string", "sort_by"=>"", "visible"=>"true", "on_js_event"=>"", "source"=>$fill_from_array),
	"id_inf"       =>array("header"=>"Cód. Inf.", "type"=>"label", "align"=>"center", "wrap"=>"wrap",   "text_length"=>"40", "case"=>"normal"),
	 "ativo"  =>array("header"=>"Ativa",  "type"=>"checkbox",  "align"=>"center", "width"=>"", "wrap"=>"nowrap", "visible"=>"true", "on_js_event"=>"", "true_value"=>"S", "false_value"=>"N"),
  );
 ...
 /// $fill_from_array = array("0"=>"No", "1"=>"Yes", "2"=>"Don't know", "3"=>"My be"); /* as "value"=>"option" */
    $em_columns = array(
        "titulo"        =>array("header"=>"Título",       "type"=>"textbox",  "width"=>"540px", "req_type"=>"rt", "title"=>"Título"),
		 "texto_centro"   =>array("header"=>"Texto Central", "type"=>"textarea", "req_type"=>"rt", "width"=>"500px", "title"=>"", "readonly"=>"false", "maxlength"=>"1024", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "edit_type"=>"wysiwyg", "resizable"=>"false", "rows"=>"10", "cols"=>"60"),	
		 "texto_rodape"  =>array("header"=>"Texto Rodapé", "type"=>"textarea",   "req_type"=>"st", "width"=>"500px", "title"=>"", "readonly"=>"false", "maxlength"=>"1024", "default"=>"", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "edit_type"=>"simple", "resizable"=>"true", "rows"=>"5", "cols"=>"50"),
		 "local_exibicao"          => array("header"=>"Local Exibição",            "type"=>"enum", "req_type"=>"rt", "width"=>"210px", "title"=>"", "readonly"=>"false", "maxlength"=>"-1", "default"=>"1", "unique"=>"false", "unique_condition"=>"", "visible"=>"true", "on_js_event"=>"", "source"=>$fill_from_array, "view_type"=>"radiobutton", "elements_alignment"=>"horizontal|vertical", "multiple"=>"false", "multiple_size"=>"4"),
