...
$_SESSION['us_nome'];
 ...
 ##  *** put a primary key on the first place 
    $sql=" SELECT 
            id_curso, 
            curso                    
        FROM curso where id_curso > 1";
  $default_order = array("curso"=>"ASC");
...
//  $export_all = false;
 ...
 /// $fill_from_array = array("0"=>"No", "1"=>"Yes");  /* as "value"=>"option" */
  $filtering_fields = array(
    "Curso"       =>array("type"=>"textbox",  "table"=>"curso", "field"=>"curso", "show_operator"=>"false", "default_operator"=>"like%", "case_sensitive"=>"false", "comparison_type"=>"string", "width"=>"200px", "on_js_event"=>"") );
 ...
 ##  ***      "barchart" : number format in SELECT SQL must be equal with number format in max_value
  ...
  $vm_colimns = array(
    "curso"       =>array("header"=>"Curso", "type"=>"label", "align"=>"left", "wrap"=>"wrap",   "text_length"=>"40", "case"=>"normal")
  );
 ...
 /// $fill_from_array = array("0"=>"No", "1"=>"Yes", "2"=>"Don't know", "3"=>"My be"); /* as "value"=>"option" */
    $em_columns = array(
        "curso"        =>array("header"=>"Curso",       "type"=>"textbox",  "width"=>"340px", "req_type"=>"rt", "title"=>"Curso")   
    );
